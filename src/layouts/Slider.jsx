...
export function Slider() {
  const images = [
    "https://images.unsplash.com/photo-1597220323807-32d922780926?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  return (
    <ImagesSlider className="h-[40rem]" images={images}>
      ...
      >
        <motion.p className="font-bold text-xl md:text-6xl text-center bg-clip-text text-white bg-transparent py-4">
          <CoverDemo />
        </motion.p>
